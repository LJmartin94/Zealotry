...
/**
 * Class for handling date conversions that are useful for Weather Forecast.
 */
public class WFDateUtils
{
	...
	{
		// Normalise the start date to the beginning of the (UTC) day in local time
