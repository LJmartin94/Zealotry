 ...
 */
public final class WFWeatherUtils
{
	private static final String LOG_TAG = WFWeatherUtils.class.getSimpleName();
	/**
	...
	private static double celsiusToKelvin(double temperatureInCelsius)
	{
	...
	public static String formatTemperature(Context context, double temperature)
	{
		...
		if (!ZealotryPreferences.isMetric(context))
		{
			temperature = celsiusToKelvin(temperature);
			temperatureFormatResourceId = R.string.format_temperature_Kelvin;
		}
